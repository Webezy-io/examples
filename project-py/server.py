...
from services.generated import SampleService_pb2_grpc
...
class Serve():
	def __init__(self,port):
		...
		SampleService_pb2_grpc.add_SampleServiceServicer_to_server(SampleService.SampleService(),self.server)
		self.addr = f'[::]:{port}'
